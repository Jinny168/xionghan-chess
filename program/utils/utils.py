...
def load_sound(sound_name):
    ...
    sound_paths = {
        ...
        'fc_victory': os.path.join("sounds", "fc_victory_sound.mp3"),  # 默认使用fc风格的胜利音效
        'fc_defeat': os.path.join("sounds", "fc_defeat_sound.mp3"),  # 默认使用fc风格的失败音效
