...
# 数据文件列表
datas = [('assets\\sounds\\button.wav', 'assets\\sounds'), ('assets\\sounds\\capture.wav', 'assets\\sounds'), ('assets\\sounds\\check.wav', 'assets\\sounds'), ('assets\\sounds\\choose.wav', 'assets\\sounds'), ('assets\\sounds\\defeat.wav', 'assets\\sounds'), ('assets\\sounds\\drop.wav', 'assets\\sounds'), ('assets\\sounds\\eat.wav', 'assets\\sounds'), ('assets\\sounds\\fc_background_sound.mp3', 'assets\\sounds'), ('assets\\sounds\\fc_background_sound.wav', 'assets\\sounds'), ('assets\\sounds\\fc_defeat_sound.mp3', 'assets\\sounds'), ('assets\\sounds\\fc_defeat_sound.wav', 'assets\\sounds'), ('assets\\sounds\\fc_victory_sound.mp3', 'assets\\sounds'), ('assets\\sounds\\fc_victory_sound.wav', 'assets\\sounds'), ('assets\\sounds\\jiangjun.wav', 'assets\\sounds'), ('assets\\sounds\\juesha.wav', 'assets\\sounds'), ('assets\\sounds\\move.wav', 'assets\\sounds'), ('assets\\sounds\\qq_background_sound.mp3', 'assets\\sounds'), ('assets\\sounds\\qq_background_sound.wav', 'assets\\sounds'), ('assets\\sounds\\qq_defeat_sound.wav', 'assets\\sounds'), ('assets\\sounds\\qq_victory_sound.wav', 'assets\\sounds'), ('assets\\sounds\\select.wav', 'assets\\sounds'), ('assets\\sounds\\victory.wav', 'assets\\sounds'), ('assets\\sounds\\warn.wav', 'assets\\sounds'), ('sounds/check.wav', 'sounds'), ('sounds/move.wav', 'sounds'), ('sounds/capture.wav', 'sounds'), ('sounds/button.wav', 'sounds'), ('sounds/choose.wav', 'sounds'), ('sounds/defeat.wav', 'sounds'), ('sounds/drop.wav', 'sounds'), ('sounds/eat.wav', 'sounds'), ('sounds/jiangjun.wav', 'sounds'), ('sounds/juesha.wav', 'sounds'), ('sounds/select.wav', 'sounds'), ('sounds/victory.wav', 'sounds'), ('sounds/warn.wav', 'sounds'), ('sounds/fc_background_sound.wav', 'sounds'), ('sounds/fc_defeat_sound.wav', 'sounds'), ('sounds/fc_victory_sound.wav', 'sounds'), ('sounds/qq_background_sound.wav', 'sounds'), ('sounds/qq_defeat_sound.wav', 'sounds'), ('sounds/qq_victory_sound.wav', 'sounds'), ('assets\\fonts\\fangsong.ttf', 'assets\\fonts'), ('assets\\fonts\\kaiti.ttf', 'assets\\fonts'), ('assets\\fonts\\msyh.ttc', 'assets\\fonts'), ('assets\\fonts\\simhei.ttf', 'assets\\fonts'), ('assets\\fonts\\simkai.ttf', 'assets\\fonts'), ('assets\\fonts\\xingkai.ttf', 'assets\\fonts'), ('fonts/fangsong.ttf', 'fonts'), ('fonts/kaiti.ttf', 'fonts'), ('fonts/msyh.ttc', 'fonts'), ('fonts/simhei.ttf', 'fonts'), ('fonts/simkai.ttf', 'fonts'), ('fonts/xingkai.ttf', 'fonts'), ('assets\\pics\\1.jpg', 'assets\\pics'), ('assets\\pics\\2.jpg', 'assets\\pics'), ('assets\\pics\\3.jpg', 'assets\\pics'), ('assets\\pics\\4.jpg', 'assets\\pics'), ('assets/1.jpg', 'assets'), ('assets/2.jpg', 'assets'), ('assets/3.jpg', 'assets'), ('assets/4.jpg', 'assets'), ('ui/help.md', 'ui'), ('ui/about.md', 'ui'), ('../README.md', '.'), ('config/taunts.json', 'config'), ('config/statistics.json', 'config')]
