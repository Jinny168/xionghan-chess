...
export function applyStaticI18n() {
  ...
  const labelKeys = [
    ...
    ['#backgroundSelect', 'settings.background'],
  ...
  setOption('#backgroundSelect', 'none', 'option.background_none');
  ['1', '2', '3', '4', '5'].forEach(value => setOption('#backgroundSelect', value, `option.background_${value}`));
  ...
  setText('#settingsDialog fieldset:nth-child(1) legend', 'settings.appearance');
  setText('#settingsDialog fieldset:nth-child(2) legend', 'settings.sound');
  setText('#settingsDialog fieldset:nth-child(3) legend', 'settings.assist');
