# 添加MCTS和神经网络相关导入
from desktop.ai.xionghan_chess_mcts_ai import XionghanChessMctsAI

# 导入传统AI和传统中国象棋AI
from desktop.ai.xionghan_chess_search_ai import XionghanChessSearchAI
from desktop.ai.chinese_chess_search_ai import ChineseChessSearchAI

try:
    from desktop.ai.mcts.mcts import MCTSPlayer
    from desktop.ai.mcts.pytorch_net import PolicyValueNet
    from desktop.ai.mcts.mcts_config import CONFIG as MCTS_CONFIG
    from desktop.ai.mcts.mcts_game import Board, move_id2move_action, move_action2move_id
    MCTS_AVAILABLE = True
except ImportError:
