...
from desktop.ai.mcts.mcts_config import CONFIG
from desktop.ai.mcts.mcts_game import Board, Game, move_action2move_id, move_id2move_action, flip_map
from desktop.ai.mcts.mcts import MCTSPlayer

if CONFIG['use_redis']:
    import desktop.ai.mcts.my_redis as my_redis

import desktop.ai.mcts.zip_array as zip_array

if CONFIG['use_frame'] == 'paddle':
    from desktop.ai.mcts.paddle_net import PolicyValueNet
