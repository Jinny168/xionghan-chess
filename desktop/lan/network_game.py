...
from desktop.game import ChessGame
from desktop.lan.xhlan import XiangqiNetworkGame, SimpleAPI
from desktop.ui.dialogs import PopupDialog, ConfirmDialog
from desktop.ui.dialogs import PromotionDialog
from desktop.ui.network_game_screen import NetworkGameScreen
...
class NetworkChessGame(ChessGame):
    ...
    def handle_full_state_sync(self, full_state_data):
        ...
        try:
            ...
            # 恢复棋子位置
            from desktop.core.chess_pieces import PieceFactory
